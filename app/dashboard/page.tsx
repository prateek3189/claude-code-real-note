    ...
    <div className='min-h-screen bg-violet-50 dark:bg-violet-950'>
      ...
      <main className='mx-auto max-w-3xl px-6 py-10'>
        <div className='flex items-center justify-between'>
          ...
          <Link
            href='/notes/new'
            className='rounded-lg bg-violet-700 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-violet-800 dark:bg-violet-600 dark:hover:bg-violet-500'
          >
            New note
          </Link>
        </div>
